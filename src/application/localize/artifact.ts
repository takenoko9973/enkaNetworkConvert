...
export class LocalizeArtifact implements ILocalize {
    ...
    format() {
        ...
        cssManager.addStyle(
            ...
            `.mainstat.${svelte} > div.${svelte}:nth-child(1) { display: flex; align-items: center; top: 5%; line-height:0.9; max-height: 25%; text-shadow: 0 0.07em 0.1em black; justify-content: flex-end; align-self: unset; margin-left: unset; }`, // 聖遺物メインステータスの調整
